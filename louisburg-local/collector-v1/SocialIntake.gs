// REPLACEMENT BUILD 2026-09-16: immediate intake processing, row isolation, retry repair, expanded current-offer classification.
...
function processSocialPostIntake(targetFingerprint) {
...
function socialFingerprintExistsElsewhere_(data,ix,currentIndex,fingerprint){
